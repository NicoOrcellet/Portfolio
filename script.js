...
const githubProyect = document.getElementById('githubProyect')
...
function checkTheme(){
    ...
    if (input.checked) {
        ...
        githubProyect.setAttribute('src','src/github-mark-white.png')
        ...
        githubProyect.setAttribute('src','src/github-mark.png')
